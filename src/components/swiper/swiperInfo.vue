<template>
  <div id=''>
             <section class="car-item">
                  ...
                  <div class="car-item-content">
                      <div class="content-left">
                          <div>
                              ...
                              <div class="electricity " :class="itemNumber">
                                <ul >
                                  <li></li>
                                  <li></li>
                                  <li></li>
                  ...
                  <footer>
                    <a href="javascript: void(0)">{{carPark}}</a>
...
<style scoped lang='scss'>
   .car-item{
      ...
      //调用封装的sass方法
      @include webkit(box-size,border-box);
